...
$('#changeSanity').submit(function (event) {
  ...
  function leiaMais1() {
      ...
      if (tresPontos1.style.display === 'none') {
          ...
          btnLeiaMais1.innerHTML = 'Guns n roses';
      } else {
  ...
  function leiaMais2() {
    ...
    if (tresPontos2.style.display === 'none') {
        ...
        btnLeiaMais2.innerHTML = 'Nise no hikari';
    } else {
  ...
  function leiaMais3() {
    ...
    if (tresPontos3.style.display === 'none') {
        ...
        btnLeiaMais3.innerHTML = 'Akumu no ibuki';
    } else {
  ...
  function leiaMais4() {
    ...
    if (tresPontos4.style.display === 'none') {
        ...
        btnLeiaMais4.innerHTML = 'Zaphkiel/Lucífegos';
    } else {
  ...
  if (tresPontos16a.style.display === 'none') {
      ...
      btnLeiaMais16a.innerHTML = 'Coroa do dragão de rá';
  } else {
  ...
  if (tresPontos17a.style.display === 'none') {
      ...
      btnLeiaMais17a.innerHTML = 'Sangue do dragão solar';
  } else {
  ...
  if (tresPontos18a.style.display === 'none') {
      ...
      btnLeiaMais18a.innerHTML = 'Coletânia de abominação';
  } else {
  ...
  if (tresPontos19a.style.display === 'none') {
      ...
      btnLeiaMais19a.innerHTML = 'Dragon force divina';
  } else {
                                                                ...
                                                                function leiaMais83b() {
                                                                  ...
                                                                  function leiaMais84b() {
                                                                      ...
                                                                      function leiaMais85b() {
                                                                        const tresPontos85b = document.getElementById('tresPontos1');
                                                                        const mostrarMais85b = document.getElementById('mostrarMais1');
                                                                        const btnLeiaMais85b = document.getElementById('btnLeiaMais1');
                                                                    
                                                                        if (tresPontos85b.style.display === 'none') {
                                                                            tresPontos85b.style.display = 'inline';
                                                                            mostrarMais85b.style.display = 'none';
                                                                            btnLeiaMais85b.innerHTML = 'Primeiro selo';
                                                                        } else {
                                                                    ...
                                                                    function leiaMais86b() {
                                                                      const tresPontos86b = document.getElementById('tresPontos2');
                                                                      const mostrarMais86b = document.getElementById('mostrarMais2');
                                                                      const btnLeiaMais86b = document.getElementById('btnLeiaMais2');
                                                                    
                                                                      if (tresPontos86b.style.display === 'none') {
                                                                          tresPontos86b.style.display = 'inline';
                                                                          mostrarMais86b.style.display = 'none';
                                                                          btnLeiaMais86b.innerHTML = 'Segundo selo';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais87b() {
                                                                      const tresPontos87b = document.getElementById('tresPontos3');
                                                                      const mostrarMais87b = document.getElementById('mostrarMais3');
                                                                      const btnLeiaMais87b = document.getElementById('btnLeiaMais3');
                                                                    
                                                                      if (tresPontos87b.style.display === 'none') {
                                                                          tresPontos87b.style.display = 'inline';
                                                                          mostrarMais87b.style.display = 'none';
                                                                          btnLeiaMais87b.innerHTML = 'terceiro selo';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais88b() {
                                                                      const tresPontos88b = document.getElementById('tresPontos4');
                                                                      const mostrarMais88b = document.getElementById('mostrarMais4');
                                                                      const btnLeiaMais88b = document.getElementById('btnLeiaMais4');
                                                                    
                                                                      if (tresPontos88b.style.display === 'none') {
                                                                          tresPontos88b.style.display = 'inline';
                                                                          mostrarMais88b.style.display = 'none';
                                                                          btnLeiaMais88b.innerHTML = 'Maldição da bomba';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais89b() {
                                                                      const tresPontos89b = document.getElementById('tresPontos5');
                                                                      const mostrarMais89b = document.getElementById('mostrarMais5');
                                                                      const btnLeiaMais89b = document.getElementById('btnLeiaMais5');
                                                                    
                                                                      if (tresPontos89b.style.display === 'none') {
                                                                          tresPontos89b.style.display = 'inline';
                                                                          mostrarMais89b.style.display = 'none';
                                                                          btnLeiaMais89b.innerHTML = 'Tenga goken';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais90b() {
                                                                      const tresPontos90b = document.getElementById('tresPontos6');
                                                                      const mostrarMais90b = document.getElementById('mostrarMais6');
                                                                      const btnLeiaMais90b = document.getElementById('btnLeiaMais6');
                                                                    
                                                                      if (tresPontos90b.style.display === 'none') {
                                                                          tresPontos90b.style.display = 'inline';
                                                                          mostrarMais90b.style.display = 'none';
                                                                          btnLeiaMais90b.innerHTML = 'Tenchi Kaimei';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais91b() {
                                                                      const tresPontos91b = document.getElementById('tresPontos7');
                                                                      const mostrarMais91b = document.getElementById('mostrarMais7');
                                                                      const btnLeiaMais91b = document.getElementById('btnLeiaMais7');
                                                                    
                                                                      if (tresPontos91b.style.display === 'none') {
                                                                          tresPontos91b.style.display = 'inline';
                                                                          mostrarMais91b.style.display = 'none';
                                                                          btnLeiaMais91b.innerHTML = 'Devil slayer de gelo';
                                                                      } else {
                                                                          tresPontos91b.style.display = 'none';
                                                                          mostrarMais91b.style.display = 'inline';
                                                                          btnLeiaMais91b.innerHTML = 'Devil slayer de gelo';
                                                                      }
                                                                    }
                                                                    function leiaMais92b() {
                                                                      const tresPontos92b = document.getElementById('tresPontos8');
                                                                      const mostrarMais92b = document.getElementById('mostrarMais8');
                                                                      const btnLeiaMais92b = document.getElementById('btnLeiaMais8');
                                                                    
                                                                      if (tresPontos92b.style.display === 'none') {
                                                                          tresPontos92b.style.display = 'inline';
                                                                          mostrarMais92b.style.display = 'none';
                                                                          btnLeiaMais92b.innerHTML = 'Maldição dos espinhos';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais93b() {
                                                                      const tresPontos93b = document.getElementById('tresPontos9');
                                                                      const mostrarMais93b = document.getElementById('mostrarMais9');
                                                                      const btnLeiaMais93b = document.getElementById('btnLeiaMais9');
                                                                    
                                                                      if (tresPontos93b.style.display === 'none') {
                                                                          tresPontos93b.style.display = 'inline';
                                                                          mostrarMais93b.style.display = 'none';
                                                                          btnLeiaMais93b.innerHTML = 'Absorption curse';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais94b() {
                                                                      const tresPontos94b = document.getElementById('tresPontos10');
                                                                      const mostrarMais94b = document.getElementById('mostrarMais10');
                                                                      const btnLeiaMais94b = document.getElementById('btnLeiaMais10');
                                                                    
                                                                      if (tresPontos94b.style.display === 'none') {
                                                                          tresPontos94b.style.display = 'inline';
                                                                          mostrarMais94b.style.display = 'none';
                                                                          btnLeiaMais94b.innerHTML = 'Aprimoramento';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais95b() {
                                                                      const tresPontos95b = document.getElementById('tresPontos11');
                                                                      const mostrarMais95b = document.getElementById('mostrarMais11');
                                                                      const btnLeiaMais95b = document.getElementById('btnLeiaMais11');
                                                                    
                                                                      if (tresPontos95b.style.display === 'none') {
                                                                          tresPontos95b.style.display = 'inline';
                                                                          mostrarMais95b.style.display = 'none';
                                                                          btnLeiaMais95b.innerHTML = 'Calamity Curse';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais96b() {
                                                                      const tresPontos96b = document.getElementById('tresPontos12');
                                                                      const mostrarMais96b = document.getElementById('mostrarMais12');
                                                                      const btnLeiaMais96b = document.getElementById('btnLeiaMais12');
                                                                    
                                                                      if (tresPontos96b.style.display === 'none') {
                                                                          tresPontos96b.style.display = 'inline';
                                                                          mostrarMais96b.style.display = 'none';
                                                                          btnLeiaMais96b.innerHTML = 'Macro';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais97b() {
                                                                      const tresPontos97b = document.getElementById('tresPontos13');
                                                                      const mostrarMais97b = document.getElementById('mostrarMais13');
                                                                      const btnLeiaMais97b = document.getElementById('btnLeiaMais13');
                                                                    
                                                                      if (tresPontos97b.style.display === 'none') {
                                                                          tresPontos97b.style.display = 'inline';
                                                                          mostrarMais97b.style.display = 'none';
                                                                          btnLeiaMais97b.innerHTML = 'Conexão';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais98b() {
                                                                      const tresPontos98b = document.getElementById('tresPontos14');
                                                                      const mostrarMais98b = document.getElementById('mostrarMais14');
                                                                      const btnLeiaMais98b = document.getElementById('btnLeiaMais14');
                                                                    
                                                                      if (tresPontos98b.style.display === 'none') {
                                                                          tresPontos98b.style.display = 'inline';
                                                                          mostrarMais98b.style.display = 'none';
                                                                          btnLeiaMais98b.innerHTML = 'Demon eyes';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais99b() {
                                                                      const tresPontos99b = document.getElementById('tresPontos15');
                                                                      const mostrarMais99b = document.getElementById('mostrarMais15');
                                                                      const btnLeiaMais99b = document.getElementById('btnLeiaMais15');
                                                                    
                                                                      if (tresPontos99b.style.display === 'none') {
                                                                          tresPontos99b.style.display = 'inline';
                                                                          mostrarMais99b.style.display = 'none';
                                                                          btnLeiaMais99b.innerHTML = 'Necromancer';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais100b() {
                                                                      const tresPontos100b = document.getElementById('tresPontos16');
                                                                      const mostrarMais100b = document.getElementById('mostrarMais16');
                                                                      const btnLeiaMais100b = document.getElementById('btnLeiaMais16');
                                                                    
                                                                      if (tresPontos100b.style.display === 'none') {
                                                                          tresPontos100b.style.display = 'inline';
                                                                          mostrarMais100b.style.display = 'none';
                                                                          btnLeiaMais100b.innerHTML = 'Memento mori';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais101b() {
                                                                      const tresPontos101b = document.getElementById('tresPontos17');
                                                                      const mostrarMais101b = document.getElementById('mostrarMais17');
                                                                      const btnLeiaMais101b = document.getElementById('btnLeiaMais17');
                                                                    
                                                                      if (tresPontos101b.style.display === 'none') {
                                                                          tresPontos101b.style.display = 'inline';
                                                                          mostrarMais101b.style.display = 'none';
                                                                          btnLeiaMais101b.innerHTML = 'Telepatia';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais102b() {
                                                                      const tresPontos102b = document.getElementById('tresPontos18');
                                                                      const mostrarMais102b = document.getElementById('mostrarMais18');
                                                                      const btnLeiaMais102b = document.getElementById('btnLeiaMais18');
                                                                    
                                                                      if (tresPontos102b.style.display === 'none') {
                                                                          tresPontos102b.style.display = 'inline';
                                                                          mostrarMais102b.style.display = 'none';
                                                                          btnLeiaMais102b.innerHTML = 'Alegria';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais103b() {
                                                                      const tresPontos103b = document.getElementById('tresPontos19');
                                                                      const mostrarMais103b = document.getElementById('mostrarMais19');
                                                                      const btnLeiaMais103b = document.getElementById('btnLeiaMais19');
                                                                    
                                                                      if (tresPontos103b.style.display === 'none') {
                                                                          tresPontos103b.style.display = 'inline';
                                                                          mostrarMais103b.style.display = 'none';
                                                                          btnLeiaMais103b.innerHTML = 'Flor da Prisão';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais104b() {
                                                                      const tresPontos104b = document.getElementById('tresPontos20');
                                                                      const mostrarMais104b = document.getElementById('mostrarMais20');
                                                                      const btnLeiaMais104b = document.getElementById('btnLeiaMais20');
                                                                    
                                                                      if (tresPontos104b.style.display === 'none') {
                                                                          tresPontos104b.style.display = 'inline';
                                                                          mostrarMais104b.style.display = 'none';
                                                                          btnLeiaMais104b.innerHTML = 'Explosão';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais105b() {
                                                                      const tresPontos105b = document.getElementById('tresPontos21');
                                                                      const mostrarMais105b = document.getElementById('mostrarMais21');
                                                                      const btnLeiaMais105b = document.getElementById('btnLeiaMais21');
                                                                    
                                                                      if (tresPontos105b.style.display === 'none') {
                                                                          tresPontos105b.style.display = 'inline';
                                                                          mostrarMais105b.style.display = 'none';
                                                                          btnLeiaMais105b.innerHTML = 'Dea Yggdrasil';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais106b() {
                                                                      const tresPontos106b = document.getElementById('tresPontos22');
                                                                      const mostrarMais106b = document.getElementById('mostrarMais22');
                                                                      const btnLeiaMais106b = document.getElementById('btnLeiaMais22');
                                                                    
                                                                      if (tresPontos106b.style.display === 'none') {
                                                                          tresPontos106b.style.display = 'inline';
                                                                          mostrarMais106b.style.display = 'none';
                                                                          btnLeiaMais106b.innerHTML = 'Organic Link Magic';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais107b() {
                                                                      const tresPontos107b = document.getElementById('tresPontos23');
                                                                      const mostrarMais107b = document.getElementById('mostrarMais23');
                                                                      const btnLeiaMais107b = document.getElementById('btnLeiaMais23');
                                                                    
                                                                      if (tresPontos107b.style.display === 'none') {
                                                                          tresPontos107b.style.display = 'inline';
                                                                          mostrarMais107b.style.display = 'none';
                                                                          btnLeiaMais107b.innerHTML = 'Aprimoramento por segundo';
                                                                      } else {
                                                                    ...
                                                                    function leiaMais108b() {
                                                                      const tresPontos108b = document.getElementById('tresPontos24');
                                                                      const mostrarMais108b = document.getElementById('mostrarMais24');
                                                                      const btnLeiaMais108b = document.getElementById('btnLeiaMais24');
                                                                    
                                                                      if (tresPontos108b.style.display === 'none') {
                                                                          tresPontos108b.style.display = 'inline';
                                                                          mostrarMais108b.style.display = 'none';
                                                                          btnLeiaMais108b.innerHTML = 'Capture bomb';
                                                                      } else {
                                                                          tresPontos108b.style.display = 'none';
                                                                          mostrarMais108b.style.display = 'inline';
                                                                          btnLeiaMais108b.innerHTML = 'Capture bomb';
                                                                      }
                                                                    }
                                                                    function leiaMais109b() {
                                                                      const tresPontos109b = document.getElementById('tresPontos25');
                                                                      const mostrarMais109b = document.getElementById('mostrarMais25');
                                                                      const btnLeiaMais109b = document.getElementById('btnLeiaMais25');
                                                                    
                                                                      if (tresPontos109b.style.display === 'none') {
                                                                          tresPontos109b.style.display = 'inline';
                                                                          mostrarMais109b.style.display = 'none';
                                                                          btnLeiaMais109b.innerHTML = 'Revolução';
                                                                      } else {
                                                                          tresPontos109b.style.display = 'none';
                                                                          mostrarMais109b.style.display = 'inline';
                                                                          btnLeiaMais109b.innerHTML = 'Revolução';
                                                                      }
                                                                    }
                                                                    function leiaMais110b() {
                                                                      const tresPontos110b = document.getElementById('tresPontos26');
                                                                      const mostrarMais110b = document.getElementById('mostrarMais26');
                                                                      const btnLeiaMais110b = document.getElementById('btnLeiaMais26');
                                                                    
                                                                      if (tresPontos110b.style.display === 'none') {
                                                                          tresPontos110b.style.display = 'inline';
                                                                          mostrarMais110b.style.display = 'none';
                                                                          btnLeiaMais110b.innerHTML = 'Ejeção';
                                                                      } else {
                                                                          tresPontos110b.style.display = 'none';
                                                                          mostrarMais110b.style.display = 'inline';
                                                                          btnLeiaMais110b.innerHTML = 'Ejeção';
                                                                      }
                                                                    }
                                                                    
                                                                    function leiaMais111b() {
                                                                      const tresPontos111b = document.getElementById('tresPontos27');
                                                                      const mostrarMais111b = document.getElementById('mostrarMais27');
                                                                      const btnLeiaMais111b = document.getElementById('btnLeiaMais27');
                                                                    
                                                                      if (tresPontos111b.style.display === 'none') {
                                                                          tresPontos111b.style.display = 'inline';
                                                                          mostrarMais111b.style.display = 'none';
                                                                          btnLeiaMais111b.innerHTML = 'Transformação de Áries';
                                                                      } else {
                                                                          tresPontos111b.style.display = 'none';
                                                                          mostrarMais111b.style.display = 'inline';
                                                                          btnLeiaMais111b.innerHTML = 'Transformação de Áries';
                                                                      }
                                                                    }
                                                                    function leiaMais112b() {
                                                                      const tresPontos112b = document.getElementById('tresPontos28');
                                                                      const mostrarMais112b = document.getElementById('mostrarMais28');
                                                                      const btnLeiaMais112b = document.getElementById('btnLeiaMais28');
                                                                    
                                                                      if (tresPontos112b.style.display === 'none') {
                                                                          tresPontos112b.style.display = 'inline';
                                                                          mostrarMais112b.style.display = 'none';
                                                                          btnLeiaMais112b.innerHTML = 'Transformação de touro';
                                                                      } else {
                                                                          tresPontos112b.style.display = 'none';
                                                                          mostrarMais112b.style.display = 'inline';
                                                                          btnLeiaMais112b.innerHTML = 'Transformação de touro';
                                                                      }
                                                                    }
                                                                    function leiaMais113b() {
                                                                      const tresPontos113b = document.getElementById('tresPontos29');
                                                                      const mostrarMais113b = document.getElementById('mostrarMais29');
                                                                      const btnLeiaMais113b = document.getElementById('btnLeiaMais29');
                                                                    
                                                                      if (tresPontos113b.style.display === 'none') {
                                                                          tresPontos113b.style.display = 'inline';
                                                                          mostrarMais113b.style.display = 'none';
                                                                          btnLeiaMais113b.innerHTML = 'Transformação de hades';
                                                                      } else {
                                                                          tresPontos113b.style.display = 'none';
                                                                          mostrarMais113b.style.display = 'inline';
                                                                          btnLeiaMais113b.innerHTML = 'Transformação de hades';
                                                                      }
                                                                    }
                                                                    function leiaMais114b() {
                                                                      const tresPontos114b = document.getElementById('tresPontos30');
                                                                      const mostrarMais114b = document.getElementById('mostrarMais30');
                                                                      const btnLeiaMais114b = document.getElementById('btnLeiaMais30');
                                                                    
                                                                      if (tresPontos114b.style.display === 'none') {
                                                                          tresPontos114b.style.display = 'inline';
                                                                          mostrarMais114b.style.display = 'none';
                                                                          btnLeiaMais114b.innerHTML = 'Transformação do Modo Dragão de Fogo Relâmpago';
                                                                      } else {
                                                                          tresPontos114b.style.display = 'none';
                                                                          mostrarMais114b.style.display = 'inline';
                                                                          btnLeiaMais114b.innerHTML = 'Transformação do Modo Dragão de Fogo Relâmpago';
                                                                      }
                                                                    }
                                                                    function leiaMais115b() {
                                                                      const tresPontos115b = document.getElementById('tresPontos31');
                                                                      const mostrarMais115b = document.getElementById('mostrarMais31');
                                                                      const btnLeiaMais115b = document.getElementById('btnLeiaMais31');
                                                                    
                                                                      if (tresPontos115b.style.display === 'none') {
                                                                          tresPontos115b.style.display = 'inline';
                                                                          mostrarMais115b.style.display = 'none';
                                                                          btnLeiaMais115b.innerHTML = 'Inferno';
                                                                      } else {
                                                                          tresPontos115b.style.display = 'none';
                                                                          mostrarMais115b.style.display = 'inline';
                                                                          btnLeiaMais115b.innerHTML = 'Inferno';
                                                                      }
                                                                    }
                                                                    function leiaMais116b() {
                                                                      const tresPontos116b = document.getElementById('tresPontos32');
                                                                      const mostrarMais116b = document.getElementById('mostrarMais32');
                                                                      const btnLeiaMais116b = document.getElementById('btnLeiaMais32');
                                                                    
                                                                      if (tresPontos116b.style.display === 'none') {
                                                                          tresPontos116b.style.display = 'inline';
                                                                          mostrarMais116b.style.display = 'none';
                                                                          btnLeiaMais116b.innerHTML = 'Demonic Eye Unleashed';
                                                                      } else {
                                                                          tresPontos116b.style.display = 'none';
                                                                          mostrarMais116b.style.display = 'inline';
                                                                          btnLeiaMais116b.innerHTML = 'Demonic Eye Unleashed';
                                                                      }
                                                                    }
                                                                    function leiaMais117b() {
                                                                      const tresPontos117b = document.getElementById('tresPontos33');
                                                                      const mostrarMais117b = document.getElementById('mostrarMais33');
                                                                      const btnLeiaMais117b = document.getElementById('btnLeiaMais33');
                                                                    
                                                                      if (tresPontos117b.style.display === 'none') {
                                                                          tresPontos117b.style.display = 'inline';
                                                                          mostrarMais117b.style.display = 'none';
                                                                          btnLeiaMais117b.innerHTML = 'Self explosion';
                                                                      } else {
                                                                          tresPontos117b.style.display = 'none';
                                                                          mostrarMais117b.style.display = 'inline';
                                                                          btnLeiaMais117b.innerHTML = 'Self explosion';
                                                                      }
                                                                    }
                                                                    function leiaMais118b() {
                                                                      const tresPontos118b = document.getElementById('tresPontos34');
                                                                      const mostrarMais118b = document.getElementById('mostrarMais34');
                                                                      const btnLeiaMais118b = document.getElementById('btnLeiaMais34');
                                                                    
                                                                      if (tresPontos118b.style.display === 'none') {
                                                                          tresPontos118b.style.display = 'inline';
                                                                          mostrarMais118b.style.display = 'none';
                                                                          btnLeiaMais118b.innerHTML = 'Julgamento da Estrela Maléfica';
                                                                      } else {
                                                                          tresPontos118b.style.display = 'none';
                                                                          mostrarMais118b.style.display = 'inline';
                                                                          btnLeiaMais118b.innerHTML = 'Julgamento da Estrela Maléfica';
                                                                      }
                                                                    }
                                                                    function leiaMais119b() {
                                                                      const tresPontos119b = document.getElementById('tresPontos35');
                                                                      const mostrarMais119b = document.getElementById('mostrarMais35');
                                                                      const btnLeiaMais119b = document.getElementById('btnLeiaMais35');
                                                                    
                                                                      if (tresPontos119b.style.display === 'none') {
                                                                          tresPontos119b.style.display = 'inline';
                                                                          mostrarMais119b.style.display = 'none';
                                                                          btnLeiaMais119b.innerHTML = 'Portão Defeituoso';
                                                                      } else {
                                                                          tresPontos119b.style.display = 'none';
                                                                          mostrarMais119b.style.display = 'inline';
                                                                          btnLeiaMais119b.innerHTML = 'Portão Defeituoso';
                                                                      }
                                                                    }
                                                                    function leiaMais120b() {
                                                                      const tresPontos120b = document.getElementById('tresPontos36');
                                                                      const mostrarMais120b = document.getElementById('mostrarMais36');
                                                                      const btnLeiaMais120b = document.getElementById('btnLeiaMais36');
                                                                    
                                                                      if (tresPontos120b.style.display === 'none') {
                                                                          tresPontos120b.style.display = 'inline';
                                                                          mostrarMais120b.style.display = 'none';
                                                                          btnLeiaMais120b.innerHTML = 'Pseudo Espírito de Afinidade';
                                                                      } else {
                                                                          tresPontos120b.style.display = 'none';
                                                                          mostrarMais120b.style.display = 'inline';
                                                                          btnLeiaMais120b.innerHTML = 'Pseudo Espírito de Afinidade';
                                                                      }
                                                                    }
                                                                      function leiaMais120b() {
                                                                        const tresPontos120b = document.getElementById('tresPontos37');
                                                                        const mostrarMais120b = document.getElementById('mostrarMais37');
                                                                        const btnLeiaMais120b = document.getElementById('btnLeiaMais37');
                                                                      
                                                                        if (tresPontos120b.style.display === 'none') {
                                                                            tresPontos120b.style.display = 'inline';
                                                                            mostrarMais120b.style.display = 'none';
                                                                            btnLeiaMais120b.innerHTML = 'F.Rashomon';
                                                                        } else {
                                                                            tresPontos120b.style.display = 'none';
                                                                            mostrarMais120b.style.display = 'inline';
                                                                            btnLeiaMais120b.innerHTML = 'F.Rashomon';
