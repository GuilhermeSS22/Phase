...
function leiaMais5() {
    ...
    if (tresPontos5.style.display === 'none') {
        ...
        btnLeiaMais5.innerHTML = 'Cataclismo';
    } else {
...
function leiaMais6() {
    ...
    if (tresPontos6.style.display === 'none') {
        ...
        btnLeiaMais6.innerHTML = 'Aurora absoluta';
    } else {
...
function leiaMais7() {
    ...
    if (tresPontos7.style.display === 'none') {
        ...
        btnLeiaMais7.innerHTML = 'Presas invernais';
    } else {
...
function leiaMais8() {
    ...
    if (tresPontos8.style.display === 'none') {
        ...
        btnLeiaMais8.innerHTML = 'Tempestade de fogo';
    } else {
...
function leiaMais9() {
    ...
    if (tresPontos9.style.display === 'none') {
        ...
        btnLeiaMais9.innerHTML = 'Talassofobia';
    } else {
...
function leiaMais10() {
    ...
    if (tresPontos10.style.display === 'none') {
        ...
        btnLeiaMais10.innerHTML = 'Avanço dos pesadelos';
    } else {
...
function leiaMais11() {
    ...
    if (tresPontos11.style.display === 'none') {
        ...
        btnLeiaMais11.innerHTML = 'Princesa vampira';
    } else {
...
function leiaMais12() {
    ...
    if (tresPontos12.style.display === 'none') {
        ...
        btnLeiaMais12.innerHTML = 'Presença da realeza';
    } else {
...
function leiaMais13() {
    ...
    if (tresPontos13.style.display === 'none') {
        ...
        btnLeiaMais13.innerHTML = 'Rasiel';
    } else {
...
function leiaMais108b() {
    const tresPontos108b = document.getElementById('tresPontos108b');
    const mostrarMais108b = document.getElementById('mostrarMais108b');
    const btnLeiaMais108b = document.getElementById('btnLeiaMais108b');
...
function leiaMais109b() {
    const tresPontos109b = document.getElementById('tresPontos109b');
    const mostrarMais109b = document.getElementById('mostrarMais109b');
    const btnLeiaMais109b = document.getElementById('btnLeiaMais109b');
...
function leiaMais110b() {
    const tresPontos110b = document.getElementById('tresPontos110b');
    const mostrarMais110b = document.getElementById('mostrarMais110b');
    const btnLeiaMais110b = document.getElementById('btnLeiaMais110b');
...
function leiaMais111b() {
    const tresPontos111b = document.getElementById('tresPontos111b');
    const mostrarMais111b = document.getElementById('mostrarMais111b');
    const btnLeiaMais111b = document.getElementById('btnLeiaMais111b');
...
function leiaMais112b() {
    const tresPontos112b = document.getElementById('tresPontos112b');
    const mostrarMais112b = document.getElementById('mostrarMais112b');
    const btnLeiaMais112b = document.getElementById('btnLeiaMais112b');
...
function leiaMais113b() {
    const tresPontos113b = document.getElementById('tresPontos113b');
    const mostrarMais113b = document.getElementById('mostrarMais113b');
    const btnLeiaMais113b = document.getElementById('btnLeiaMais113b');
...
function leiaMais114b() {
    const tresPontos114b = document.getElementById('tresPontos114b');
    const mostrarMais114b = document.getElementById('mostrarMais114b');
    const btnLeiaMais114b = document.getElementById('btnLeiaMais114b');
...
function leiaMais115b() {
    const tresPontos115b = document.getElementById('tresPontos115b');
    const mostrarMais115b = document.getElementById('mostrarMais115b');
    const btnLeiaMais115b = document.getElementById('btnLeiaMais115b');
...
function leiaMais116b() {
    const tresPontos116b = document.getElementById('tresPontos116b');
    const mostrarMais116b = document.getElementById('mostrarMais116b');
    const btnLeiaMais116b = document.getElementById('btnLeiaMais116b');
...
function leiaMais117b() {
    const tresPontos117b = document.getElementById('tresPontos117b');
    const mostrarMais117b = document.getElementById('mostrarMais117b');
    const btnLeiaMais117b = document.getElementById('btnLeiaMais117b');
...
function leiaMais118b() {
    const tresPontos118b = document.getElementById('tresPontos118b');
    const mostrarMais118b = document.getElementById('mostrarMais118b');
    const btnLeiaMais118b = document.getElementById('btnLeiaMais118b');
...
function leiaMais119b() {
    const tresPontos119b = document.getElementById('tresPontos119b');
    const mostrarMais119b = document.getElementById('mostrarMais119b');
    const btnLeiaMais119b = document.getElementById('btnLeiaMais119b');

    if (tresPontos119b.style.display === 'none') {
        tresPontos119b.style.display = 'inline';
        mostrarMais119b.style.display = 'none';
        btnLeiaMais119b.innerHTML = 'Pseudo Espírito de Afinidade';
    } else {
...
function leiaMais120b() {
    const tresPontos120b = document.getElementById('tresPontos120b');
    const mostrarMais120b = document.getElementById('mostrarMais120b');
    const btnLeiaMais120b = document.getElementById('btnLeiaMais120b');
...
function leiaMais121b() {
    const tresPontos121b = document.getElementById('tresPontos121b');
    const mostrarMais121b = document.getElementById('mostrarMais121b');
    const btnLeiaMais121b = document.getElementById('btnLeiaMais121b');

    if (tresPontos121b.style.display === 'none') {
        tresPontos121b.style.display = 'inline';
        mostrarMais121b.style.display = 'none';
        btnLeiaMais121b.innerHTML = 'Mochi Mochi no mi';
    } else {
        tresPontos121b.style.display = 'none';
        mostrarMais121b.style.display = 'inline';
        btnLeiaMais121b.innerHTML = 'Mochi Mochi no mi';
    }
}
function leiaMais122b() {
    const tresPontos122b = document.getElementById('tresPontos122b');
    const mostrarMais122b = document.getElementById('mostrarMais122b');
    const btnLeiaMais122b = document.getElementById('btnLeiaMais122b');

    if (tresPontos122b.style.display === 'none') {
        tresPontos122b.style.display = 'inline';
        mostrarMais122b.style.display = 'none';
        btnLeiaMais122b.innerHTML = 'Gura Gura no mi';
    } else {
        tresPontos122b.style.display = 'none';
        mostrarMais122b.style.display = 'inline';
        btnLeiaMais122b.innerHTML = 'Gura Gura no mi';
    }
}
function leiaMais123b() {
    const tresPontos123b = document.getElementById('tresPontos123b');
    const mostrarMais123b = document.getElementById('mostrarMais123b');
    const btnLeiaMais123b = document.getElementById('btnLeiaMais123b');

    if (tresPontos123b.style.display === 'none') {
        tresPontos123b.style.display = 'inline';
        mostrarMais123b.style.display = 'none';
        btnLeiaMais123b.innerHTML = 'Soru Soru no mi';
    } else {
        tresPontos123b.style.display = 'none';
        mostrarMais123b.style.display = 'inline';
        btnLeiaMais123b.innerHTML = 'Soru Soru no mi';
    }
}
function leiaMais124b() {
    const tresPontos124b = document.getElementById('tresPontos124b');
    const mostrarMais124b = document.getElementById('mostrarMais124b');
    const btnLeiaMais124b = document.getElementById('btnLeiaMais124b');

    if (tresPontos124b.style.display === 'none') {
        tresPontos124b.style.display = 'inline';
        mostrarMais124b.style.display = 'none';
        btnLeiaMais124b.innerHTML = 'Haki de aprimoramento avançado';
    } else {
        tresPontos124b.style.display = 'none';
        mostrarMais124b.style.display = 'inline';
        btnLeiaMais124b.innerHTML = 'Haki de aprimoramento avançado';
    }
}
function leiaMais125b() {
    const tresPontos125b = document.getElementById('tresPontos125b');
    const mostrarMais125b = document.getElementById('mostrarMais125b');
    const btnLeiaMais125b = document.getElementById('btnLeiaMais125b');

    if (tresPontos125b.style.display === 'none') {
        tresPontos125b.style.display = 'inline';
        mostrarMais125b.style.display = 'none';
        btnLeiaMais125b.innerHTML = 'Haki de observação avançado';
    } else {
        tresPontos125b.style.display = 'none';
        mostrarMais125b.style.display = 'inline';
        btnLeiaMais125b.innerHTML = 'Haki de observação avançado';
    }
}
